...
SECRET_KEY = 'django-insecure-jbx8dfu&kuh9941u3ica&$&z#1w10+fn_d%mnfn%du+l2q80y1'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'capoff_db',  # Имя вашей базы данных
        'USER': 'ayana',      # Имя вашего пользователя
        'PASSWORD': 'ayana17',  # Ваш пароль
